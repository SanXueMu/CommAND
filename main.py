...
def create_app():
    ...
    import deps
    from api import data_router, files_router, keys_router, meta_router, ocr_records_router, ocr_templates_router, pipelines_router, system_router, tasks_router, tools_router, translate_router
